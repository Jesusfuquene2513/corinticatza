...
<td class="text-center" style="vertical-align: middle; border:solid 0.5px gray">' . $contacto['fecha_creacion'] . '</td>
      ...
      <img src="'.$ruta_nueva.'" class="d-block w-100 " alt="...">
    </div>';
      ...
      <div class="container p-0">
        ...
        $peticion = $instancia->listar_programas();
                                    ...
                                    foreach($peticion as $programa){
                                        ...
                                        $ruta = $programa['portada_programa'];
                                        ...
                                        echo '<div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;background:white; cursor:pointer">
                                        <div class="product-item">
                                            <div class="position-relative">
                                                <img class="img-fluid" src="'.$ruta_nueva.'" alt="">
                                                <div class="product-overlay">
                                                    <a class="btn btn-square btn-secondary rounded-circle m-1" target="_blank" href="https://api.whatsapp.com/send?phone=573182525189"><i class="bi bi-link"></i></a>
                                                    
                                                </div>
                                            </div>
                                            <div class="text-center p-4">
                                                <span class="d-block h5">'.$programa['nombre_programa'].'</span>
                                                <p style="text-aling: justify">'.$programa['contenido_programa'].'</p>
