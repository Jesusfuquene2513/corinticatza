...
<head>
    ...
    <title>DASHBOARD - CORINTICATZA</title>
...
<body class="user" id="<?php echo $window ?>">
    <div class="wrapper">
        ...
        -->
        <div class="main-header" style="background:#ec6414">
            <!-- Logo Header -->
            <div class="logo-header" style="background:white; border-bottom:1px solid #ec6414">
                
                <a href="index.html" class="logo">
                    <img src="../plantilla/img/logo.png" alt="navbar brand" class="navbar-brand" style="width:170px">
                </a>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-wrapper scrollbar-inner" style="background:#ec6414; color:white">
