...
<head>
	...
	<link rel="icon" href="../plantilla/img/icon.ico" type="image/x-icon"/>
...
<body class="login">
	<div class="wrapper wrapper-login">
		<form action="aplicacion/controllers/routes/routes.php" method="post">
			...
			<center>    <img src="../plantilla/img/logo.png" alt="navbar brand" class="navbar-brand" style="width:280px"></center>
