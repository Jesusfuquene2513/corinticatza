...
class Blog extends CI_Controller {
	...
	{
		$this->load->view('vistas/blog_corinticatza');
	}
	...
	foreach($resultado as $elemento){
		...
		echo '<div class="col-lg-4 col-md-6 natalia" style="position: relative; float:left; cursor:pointer">
                    <div class="portfolio-img rounded overflow-hidden">
                        <img class="img-fluid imagen-archivo" src="'.$ruta_nueva.'" alt="" style="height:300px; width:100%">
                        <div class="portfolio-btn" style="height:100%; background: #ec6414;position:relative ">
                           <center> <a class="btn natalia btn-lg-square  rounded-circle mx-1" href="'.$ruta_nueva.'" data-lightbox="portfolio" style="background:rgb(252, 219, 28); color:white"><i class="fa fa-eye"></i></a></center>
                         <img src="../plantilla/img/sol.png" style="width:80px; position:absolute; bottom:0; right:0">
						 <img src="../plantilla/img/sol.png" style="width:80px; position:absolute; bottom:0; left:0">
                        </div>
                    </div>
...
public function consultar_albumnes(){
	...
	foreach($resultado as $album){
		...
		echo '<button class="btn btn-primary album" style="background:#404A3D; border:none; margin-left:3px; margin-right:3px;" id="'.$album->album_id.'">Album "'.$album->nombre_album.'"</button>';
