...
//$(this).parent("a").attr("href","../../administrador/"+ruta+"");
   ...
   if(tipo_elemento == "3"){
    var ruta = $(this).attr("src");
       var iframe = '<iframe class="imagen-archivo" style="width:100%;height:380px;"  src="'+ruta+'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';
